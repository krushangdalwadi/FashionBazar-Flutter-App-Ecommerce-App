...
import 'package:madhav_ecommerece/widgets/custom_icon_button.dart';
import 'package:madhav_ecommerece/widgets/custom_outlined_button.dart';
...
class LoginScreen extends StatelessWidget {
          ...
          children: [
            Form(
                ...
                child: Container(
                    ...
                    padding:
                        EdgeInsets.only(left: 20.h, top: 68.v, right: 20.h),
  ...
  Widget _buildPageHeader(BuildContext context) {
    return Column(children: [
      ...
      SizedBox(height: 16.v),
      Text("Welcome to Fashion Bazar", style: theme.textTheme.titleMedium),
      SizedBox(height: 10.v),
